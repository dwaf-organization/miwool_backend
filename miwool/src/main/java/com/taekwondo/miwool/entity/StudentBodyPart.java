...
@Entity
@Table(name = "student_body_part")
@Getter @Setter @NoArgsConstructor @AllArgsConstructor @Builder
@EntityListeners(AuditingEntityListener.class)
public class StudentBodyPart {
    ...
    @Column(name = "body_part_code", length = 20, nullable = false)
    private String bodyPartCode; // BODY_SENS 그룹과 매핑
